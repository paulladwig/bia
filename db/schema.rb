...
ActiveRecord::Schema.define(version: 2019_12_05_110157) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "name"
    t.string "photo", default: "https://res.cloudinary.com/bia-app/image/upload/v1575539258/profile_picture_unavailable_bkap0a.svg"
    t.string "username"
    t.string "gender"
    t.string "location"
    t.text "description"
